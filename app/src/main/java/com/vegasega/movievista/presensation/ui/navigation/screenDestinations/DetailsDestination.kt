...
import com.vegasega.movievista.presensation.detailScreen.DetailsRoute
...
//    fun createNavigationRoute(mediaType: com.maximillianleonov.MovieVista.core.model.MediaType.Details) =
//        "$route/${mediaType.mediaId}/${mediaType.mediaType}"
//
//    fun fromSavedStateHandle(savedStateHandle: SavedStateHandle) = com.maximillianleonov.MovieVista.core.model.MediaType.Details.from(
