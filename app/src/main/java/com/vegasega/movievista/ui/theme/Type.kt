...
private fun defaultTypography() = with(MovieVistaTypography()) {
    Typography(
...
internal val LocalMovieVistaTypography = staticCompositionLocalOf { MovieVistaTypography() }
